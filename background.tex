...
Los resultados obtenidos para el factor en bines de $\eta , p_{T}$ se muestran en la Tabla \ref{ta:fftable} incluyendo por separada las incertezas estadísticas y sistemáticas del método (\tosolve{Agregar tabla de sistemáticos solamente}).
